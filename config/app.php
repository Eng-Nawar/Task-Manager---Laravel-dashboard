...
| .env file. There is usually no need to make changed in this file, apart
| from registering service providers etc
|
 */
...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | APPLICATION DEMO MODE [GROWCRM]
    |--------------------------------------------------------------------------
    | If you are using the application in demo mode, some functions are
    | disabled.
    |
     */
    'application_demo_mode' => env('APP_DEMO_MODE', false),

    /*
    |--------------------------------------------------------------------------
    | APPLICATION JAVASCRIPT DEBUG [GROWCRM]
    |--------------------------------------------------------------------------
    | Show javascript debug console output
    |
     */
    'debug_javascript' => env('APP_DEBUG_JAVASCRIPT', false),

    /*
    |--------------------------------------------------------------------------
    | SESSION RELOGIN WINDOW
    |--------------------------------------------------------------------------
    | You should not usually need to change this value
    |
     */
    'app_session_relogin' => env('APP_SESSION_RELOGINX, "disabledX"'),

    /*
    |--------------------------------------------------------------------------
    | UPDATE SERVER URL [GROWCRM]
    |--------------------------------------------------------------------------
    | You should not usually need to change this value
    |
     */
    'updates_server' => env('APP_UPDATES_SERVER'),

    /*
    |--------------------------------------------------------------------------
    | INSTALLED VERSION [GROWCRM]
    |--------------------------------------------------------------------------
    | The version at the point of installation.
    | You should not usually need to change this value
    |
     */
