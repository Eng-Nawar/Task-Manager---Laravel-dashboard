<head>
    ...
    <script src= "{{ asset('vendor/js/vendor.header.js') }}"></script>
    ...
    <!--ICONS-->
    <link rel="stylesheet" href="{{ asset('vendor/fonts/growcrm-icons/styles.css') }}">
    ...
    <!-- Favicon icon -->
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('images/favicon/logo-watch.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('images/favicon/logo-watch.png') }}">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="{{ asset('images/favicon/logo-title.png') }}">
    ...
    <!--boot js-->
    <script src="{{ asset('js/core/head.js') }}"></script>
