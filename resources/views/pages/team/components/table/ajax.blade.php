    ...
    <td class="team_col_action">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="@lang('lang.send_email')"
                ...
                data-url="{{ url('/webmail/compose?view=modal&resource_type=user&resource_id='.$team->id) }}"
                data-loading-target="commonModalBody" data-modal-title="@lang('lang.send_email')"
                data-action-url="{{ url('/webmail/send') }}" data-action-method="POST" data-modal-size="modal-xl"
