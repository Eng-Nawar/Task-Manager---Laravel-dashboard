<div class="col-12 align-self-center hidden checkbox-actions" id="contracts-checkbox-actions-container">
    <!--button-->
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger" 
                data-type="form"
                data-ajax-type="POST" 
                data-form-id="contracts-list-table" 
                data-url="{{ url('/contracts/delete?type=bulk') }}"
        ...
        <button type="button"
            ...
            data-action-url="{{ urlResource('/contracts/change-category?type=bulk') }}" data-action-method="POST"
            data-action-type="form" data-action-form-id="main-body" data-loading-target="actionsModalBody"
            data-skip-checkboxes-reset="TRUE" id="checkbox-actions-change-category-contracts">
