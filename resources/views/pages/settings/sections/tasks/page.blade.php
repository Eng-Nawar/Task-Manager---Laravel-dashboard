...
<form class="form">
    ...
    <div class="form-group form-group-checkbox row">
        ...
        <div class="col-8 p-t-5">
            <input type="checkbox" id="settings_tasks_kanban_client_visibility" name="settings_tasks_kanban_client_visibility"
                class="filled-in chk-col-light-blue"
    ...
    <div class="text-right">
        <button type="submit" id="commonModalSubmitButton"
            ...
            data-url="/settings/tasks" data-loading-target="" data-ajax-type="PUT" data-type="form"
