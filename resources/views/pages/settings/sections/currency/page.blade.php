...
<form class="form" id="settingsFormCurrency">
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label">{{ cleanLang(__('lang.currency_code')) }}</label>
        <div class="col-12">
            <!--[source]: https://gist.github.com/howkymike/7cc3a302f01130be924a5578a409f895 -->
            <select class="select2-basic form-control form-control-sm select2-preselected" id="settings_system_currency_code" data-preselected="{{ $settings->settings_system_currency_code ?? ''}}"
                name="settings_system_currency_code">
                <option></option>
                ...
                <option value="ZWL" label="Zimbabwean Dollar">ZWL</option>
            </select>
        </div>
    </div>
    ...
    <!--currency symbol-->
    <div class="form-group row">
        <label class="col-12 control-label col-form-label">{{ cleanLang(__('lang.currency_symbol')) }}</label>
        <div class="col-12">
            <input type="text" class="form-control form-control-sm" id="settings_system_currency_symbol"
                name="settings_system_currency_symbol" value="{{ $settings->settings_system_currency_symbol }}">
        </div>
    </div>
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label">{{ cleanLang(__('lang.decimal_separator')) }}</label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_decimal_separator"
                name="settings_system_decimal_separator">
                <option value="fullstop"
                    {{ runtimePreselected('fullstop', $settings->settings_system_decimal_separator ?? '') }}>
                    . ({{ cleanLang(__('lang.full_stop')) }})</option>
                <option value="comma"
                    {{ runtimePreselected('comma', $settings->settings_system_decimal_separator ?? '') }}>
                    , ({{ cleanLang(__('lang.comma')) }})</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group row">
        <label class="col-12 control-label col-form-label">{{ cleanLang(__('lang.thousands_separator')) }}</label>
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_thousand_separator"
                name="settings_system_thousand_separator">
                <option value="fullstop"
                    {{ runtimePreselected('fullstop', $settings->settings_system_thousand_separator ?? '') }}>
                    . ({{ cleanLang(__('lang.full_stop')) }})</option>
                <option value="comma"
                    {{ runtimePreselected('comma', $settings->settings_system_thousand_separator ?? '') }}>
                    , ({{ cleanLang(__('lang.comma')) }})</option>
                <option value="apostrophe"
                    {{ runtimePreselected("apostrophe", $settings->settings_system_thousand_separator ?? '') }}>
                    ' ({{ cleanLang(__('lang.apostrophe')) }})</option>
                <option value="none"
                    {{ runtimePreselected('none', $settings->settings_system_thousand_separator ?? '') }}>
                    {{ cleanLang(__('lang.none')) }}</option>
                <option value="space"
                    {{ runtimePreselected('space', $settings->settings_system_thousand_separator ?? '') }}>
                    {{ cleanLang(__('lang.space')) }}</option>
            </select>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_currency_position"
                ...
                <option value="left"
                    {{ runtimePreselected('left', $settings->settings_system_currency_position ?? '') }}>
                    {{ cleanLang(__('lang.left')) }}</option>
                <option value="right"
                    {{ runtimePreselected('right', $settings->settings_system_currency_position ?? '') }}>
                    {{ cleanLang(__('lang.right')) }}</option>
            </select>
        </div>
    </div>
    ...
    <div>
        ...
        <a href="https://growcrm.io/documentation/currency-settings/" target="_blank"
