            ...
            <tr>
                ...
                <td class="x-payments"> <a href="javascript:void(0)" class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                        ...
                        data-modal-size="modal-lg"><span
                            class="p-l-20">{{ runtimeMoneyFormat($bill->sum_payments) }}</span></a>
                </td>
                @else

                <td class="x-payments"> <span class="p-l-20">{{ runtimeMoneyFormat(0.00) }}</span> </td>
                @endif
            </tr>
            <tr>
                ...
                <td class="x-balance-due"> <span class="x-due-amount-label">
                        ...
                        <label class="label label-rounded label-danger"
                            id="billing-details-amount-due">{{ runtimeMoneyFormat($bill->invoice_balance) }}</label>
                        @else
                    ...
                    <!--pdf-->
                    <span class="x-due-amount-plain hidden">{{ runtimeMoneyFormat($bill->invoice_balance) }}</span>
                </td>
            </tr>
        </table>
    </div>