...
//WEBMAIL
Route::get("/webmail/compose", "Webmail\Compose@compose");
Route::post("/webmail/send", "Webmail\Compose@send")->middleware(['demoModeCheck']);
Route::get("/webmail/prefill", "Webmail\Compose@prefillTemplate");
